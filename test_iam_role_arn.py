...
# Test with IAM role ARN (not STS)
stmt = f"""permit (
    principal == AgentCore::IamEntity::"arn:aws:iam::097935663941:role/AccountFullAccessRole",
    action == AgentCore::Action::"read-record",
    resource == AgentCore::Gateway::"{gateway_arn}"
);"""

print("Deploying IAM Role ARN policy...", flush=True)
c.update_policy(
