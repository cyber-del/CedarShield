...
stmt = f"""permit (
    principal == AgentCore::IamEntity::"arn:aws:iam::097935663941:role/CedarShield-SupportAgent-Role",
    action == AgentCore::Action::"read-record",
    resource == AgentCore::Gateway::"{gateway_arn}"
);"""

print("Updating ReadRecordPolicy with exact IamEntity ARN...", flush=True)
